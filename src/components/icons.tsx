...
export const Icons = {
    ...
    articles: Newspaper,
    sliderH: SlidersHorizontal,
    alignVerticalSpaceAround: AlignVerticalSpaceAround,
    calender: CalendarRange,
    dotsH: GripHorizontal,
    reload: RotateCw,
    ...
    logo: ({ ...props }: LucideProps) => (
        <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
                d="M50 40c-5.5 0-10 4.5-10 10s4.5 10 10 10 10-4.5 10-10-4.5-10-10-10z"
                fill="#dcdcdc"
            />
            <path
                d="M50 55c-2.8 0-5-2.2-5-5s2.2-5 5-5 5 2.2 5 5-2.2 5-5 5z"
                fill="#141414"
            />
        </svg>
    ),
